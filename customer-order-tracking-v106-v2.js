/* JPT V106 — CUSTOMER ORDER TRACKING BRIDGE V3
...
(function(){
  'use strict';
  if(window.__JPT_V106_CUSTOMER_TRACKING_V3__) return;
  window.__JPT_V106_CUSTOMER_TRACKING_V3__=true;
  ...
  function statusInfo(o){
    ...
    if(s==='ready') return {title:'Ready for delivery',sub:'Your order is ready and waiting for delivery.',step:3,ready:true};
  ...
  function render(o){
    var el=ensureUI(), info=statusInfo(o||{});
    var steps=['Received','Confirmed','Preparing','Ready','Out for delivery','Delivered'];
    ...
    if(b)b.onclick=async function(){
      ...
      try{
        ...
        b.disabled=false;b.textContent='I RECEIVED MY ORDER';
  ...
  function hook(){
    ...
    if(window.placeOrder.__jptV106TrackingV3)return true;
    ...
    window.placeOrder.__jptV106TrackingV3=true;
    return true;
  }
